# Sandbox blast radius: claude-code-2.1.266-sandbox-enabled-deps-missing
...
- kind: `captured`
- label: `claude-code-2.1.266-sandbox-enabled-deps-missing`
- how: `as above plus --settings '{"sandbox":{"enabled":true}}', on a host where socat was not installed.`
...
- evidence: `{'visible_pid_count': 393, 'visible_uids': [0, 101, 103, 112, 113, 115, 117, 120, 121, 991, 992, 997, 998, 1000]}`
