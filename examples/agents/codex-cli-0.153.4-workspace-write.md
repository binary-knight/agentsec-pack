...
- how: `codex exec -m gpt-6-astra -c model_reasoning_effort=low -c service_tier=default --sandbox workspace-write --skip-git-repo-check; the probe wrote its JSON directly to a file in the workspace`
